  ...
  return (
    <div>
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .ab-eline-r {
          width: 36px; height: 1.5px;
          background: rgba(212,43,43,0.55); flex-shrink: 0;
        }
        .ab-eyebrow span {
        ...
        .ab-eyebrow-span-r { color: rgba(212,43,43,0.8) !important; }
        .ab-heading {
        ...
        .ab-val-card:hover .ab-val-icon { background: rgba(212,43,43,0.16); transform: scale(1.08); }
        .ab-val-title {
          font-family: var(--font-heading); font-weight: 900;
        ...
        .ab-tl-line-fill {
          position: absolute; inset: 0;
          background: linear-gradient(to bottom, var(--color-primary) 0%, rgba(212,43,43,0.15) 100%);
        }
        .ab-tl-item {
