        ...
        <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1.5fr', gap: '3rem' }} className="footer-grid">
          ...
          <div>
            ...
            <a href="https://wa.me/212650596613" target="_blank" rel="noopener noreferrer"
              style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', padding: '0.55rem 1.2rem', background: '#25d366', color: 'white', borderRadius: '100px', fontSize: '0.82rem', fontWeight: 700, textDecoration: 'none', transition: 'all 0.2s' }}
              className="wa-btn"
            >
