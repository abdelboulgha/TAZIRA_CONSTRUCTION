...
export default function CtaSection() {
  ...
  return (
    <section ref={ref} className="cta-section" style={{ direction: isRTL ? 'rtl' : 'ltr' }}>
      {/* Background */}
      ...
      <div className="container cta-inner">
        <div ref={cardRef} className="cta-card" style={{ opacity: 0 }}>
          ...
          <div className="cta-left">
            <div className="cta-label">{d.eyebrow}</div>
            <h2 className="cta-heading">
              {d.heading}<br />
              <span>{d.headingHighlight}</span>
            </h2>
            <p className="cta-desc">{d.description}</p>
            <div className="cta-trust">
              {d.trustItems.map((item) => (
