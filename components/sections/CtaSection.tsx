      ...
      <div className="container" style={{ position: 'relative', zIndex: 1, padding: '6.5rem 1.5rem' }}>
        ...
        >
          ...
          <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
            <Link href="/contact" className="btn btn-primary" style={{ padding: '1rem 2.25rem', fontSize: '0.9rem', letterSpacing: '0.08em', textTransform: 'uppercase' }}>
              {t.cta.button}
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M5 12h14M12 5l7 7-7 7"/></svg>
            </Link>
            <a href="https://wa.me/212650596613" target="_blank" rel="noopener noreferrer"
              className="btn btn-whatsapp" style={{ padding: '1rem 2.25rem', fontSize: '0.9rem', letterSpacing: '0.08em', textTransform: 'uppercase' }}>
